...
import Winter from "../assets/winterSale.jpg";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          <div data-aos="zoom-in">
            <img
              src={Winter}
              alt="Winter Sale"
              className="max-w-[400px] h-[350px] w-full drop-shadow-[-10px_10px_10px_rgba(0,0,0,0.1)] object-cover"
            />
          </div>
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            <h1 className="text-3xl sm:text-4xl font-bold">
              Winnter Sale upto 50% off
            </h1>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div data-aos="fade-up" className="flex items-center gap-4">
                <IoFastFood className="text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-yellow-400" />
                <p>Get Offers</p>
              </div>
            </div>
          </div>
